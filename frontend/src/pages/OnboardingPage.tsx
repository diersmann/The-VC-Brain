...
export function OnboardingPage() {
  ...
  const saveAndScore = async () => {
    ...
    try {
      await saveActiveThesis({ name: "Berlin Deep Tech", stages: selectedStages, sectors: selectedSectors, excluded_sectors: [], regions: selectedRegions, check_size_min_k_eur: minimum, check_size_max_k_eur: maximum, ownership_target_pct: 10, risk_appetite: "balanced", scoring_weights: { stage: 0.30, sector: 0.40, geography: 0.20, check_size: 0.10 } });
